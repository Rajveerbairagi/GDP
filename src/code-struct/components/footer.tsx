...
const Footer = () => {
  return (
    <footer id="footer" className="bg-transparent backdrop-blur-md text-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">G D P</h3>
            <p className="text-gray-700">Growth Driven Pioneers</p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-950">© 2025 GDP. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
